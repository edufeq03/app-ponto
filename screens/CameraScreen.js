...
// Importa as funções do serviço de câmera
import { processImage, findDocumentBoundingBox, savePointData, checkIfDuplicate } from '../services/cameraService.js';
...
export default function CameraScreen({ navigation }) {
    ...
    const savePointAndImage = async (data, justification = null) => {
        setIsSaving(true);
        try {
            const success = await savePointData(data.photoUri, data);
            if (success) {
