 ...
 */
export const processImageForVision = async (imageUri, userId) => {
  ...
  // Aqui você pode adicionar a lógica de upload e salvamento se quiser que ela aconteça automaticamente
  // const photoURL = await uploadImage(imageUri);
  // await sendToFirestore(extracted, photoURL);
